...
createToggleRow(secT1, "Auto Leave If Stuck (Mob Stagnation)", "AutoLeaveIfStuck")
createTextBoxRow(secT1, "Stagnation Time (s)", "TrialStagnationTime")
...
print("[Dominate Hub] V16.9.34 Stable Loaded Successfully!")                gemExchangeCountdown = 60
            end
        else
            gemExchangeCountdown = 60
        end
