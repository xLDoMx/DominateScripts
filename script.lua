--======================================================================================
-- DOMINATE HUB | PRO EDITION (SAFE ZONE COMBAT BREAK & STABLE BUILD)
--======================================================================================
local Env = getgenv()
...
-- SAFE ZONE VECTOR FOR COMBAT BREAK (Update this coordinates vector to your safe spot near station)
Env.SafeZoneVector = Vector3.new(1114.753, 10.310, -644.151)
...
-- COMBAT UPGRADE BREAK ROUTINE (GLIDES TO SAFE ZONE FOR 5s PAUSE)
task.spawn(function()
    while Running do
        task.wait(40.0)
        if Running and Env.AutoCombatBreak then
            ...
            if anyActive then
                ...
                task.wait(1.5) -- wait for glide arrival
                MasterTargetVector = nil
                
                task.wait(3.5) -- hold safe position for upgrade processing
...
print("[Dominate Hub] V11.53 Safe Zone Combat Break Loaded Successfully!")        corner.Parent = toast
