--======================================================================================
-- DOMINATE HUB | PRO EDITION (STABLE V16.9.87 - TUG-OF-WAR TRIAL EXIT FIX)
--======================================================================================
...
print("[Dominate Hub] V16.9.87 Stable Loaded Successfully!")-- STATS TRACKING VARIABLES FOR HUD
local oresMined = 0
local mobsKilled = 0
local lastTrackedPart = nil
local lastTrackedMobPart = nil
