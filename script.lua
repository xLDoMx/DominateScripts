--======================================================================================
-- DOMINATE HUB | PRO EDITION (FIXED ACCORDION SCROLLING & 6S PITSTOP)
--======================================================================================
local Env = getgenv()
...
-- ACCORDION DROPDOWN BUILDER WITH AUTO-EXPANDING CANVAS FIX
local function makeAccordionDropdown(title, optionsList, scr, parentScroll)
    ...
    local expandedHeight = 30 + (#optionsList * 26) + ((#optionsList - 1) * 4) + 8
    ...
    headerBtn.MouseButton1Click:Connect(function()
        ...
        -- Instantly recalculate parent scroll frame canvas size to eliminate any bottom clipping
        local conn
        conn = RunService.RenderStepped:Connect(function()
            local layout = parentScroll:FindFirstChildOfClass("UIListLayout")
            if layout then
                parentScroll.CanvasSize = UDim2.new(0, 0, 0, layout.AbsoluteContentSize.Y + 40)
            end
        end)
...
makeAccordionDropdown("Gem Upgrades", gemUpgradesList, upScrollR2, upScrollR2)
...
print("[Dominate Hub] V11.6 Base Loaded Successfully with Fixed Accordion Scrolling!")Env.AutoPrestige = false
Env.CPUSaverMode = false
