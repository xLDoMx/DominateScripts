--======================================================================================
-- DOMINATE HUB | PRO EDITION (STABLE V16.9.40 - EXACT VECTORS & ROBUST TRIAL REMOTE FIX)
--======================================================================================
...
task.spawn(function()
    while Running do
        ...
        local hrp = GetWorldRoot()
        if hrp then
            -- If player is physically deep in a trial (Z > 13000) and trialIsRunning is false, start tracking
            ...
            -- If trialIsRunning is true, but player is now back in the lobby (Z < 13000) - handles manual leave or completion
...
-- SCHEDULED TRIAL AUTOMATION (WITH 30s STAGNATION & DIRECT REMOTE LEAVE)
            ...
            if (min == 29 or min == 59) and min ~= lastTrialTriggeredMinute then
                ...
                if targetPad then
                    ...
                    while Running and trialIsRunning do
                        ...
                        -- Check if player already left manually
                        ...
                        -- Adjustable mob-count stagnation anti-stuck check using direct Remote
...
-- STABILIZED OVERWORLD & TRIAL MOB FARMING ENGINE (WITH TARGET STICKINESS)
task.spawn(function()
    while Running do
        task.wait(0.01)
...
print("[Dominate Hub] V16.9.40 Stable Loaded Successfully!")            if gemExchangeCountdown < 0 then
                gemExchangeCountdown = 60
            end
        else
            gemExchangeCountdown = 60
