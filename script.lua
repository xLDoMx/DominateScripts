--======================================================================================
-- DOMINATE HUB | PRO EDITION (STRICTLY STYLED UI OVERHAUL)[cite: 1]
--======================================================================================
local Env = getgenv()
...
print("[Dominate Hub] V11.21 Fully Refactored UI & Logic Loaded Successfully![cite: 1]")        toast:Destroy()
    end)
end
