--======================================================================================
-- DOMINATE HUB | PRO EDITION (STABLE V16.9.103 - Updatex3)
--======================================================================================
                ...
                if pGui then
                    for _, gui in ipairs(pGui:GetDescendants()) do
                        if gui:IsA("TextLabel") and gui.Text then
                            ...
                            -- Ignore progress bars, pity bars, slashes, index labels, and chat
                            if not textLower:find("/") and not textLower:find("pity") and not textLower:find("pty") and not textLower:find("index") and not textLower:find("discord") then
