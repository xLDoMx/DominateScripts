--======================================================================================
-- DOMINATE HUB | PRO EDITION (STABLE V16.9.70 - ENCHANTS AUTOMATION & DUAL TARGET MODES)
--======================================================================================
...
task.spawn(function()
    while Running do
        task.wait(0.35) -- Throttled loop to avoid server ping/spam
        if Running and Env.AutoRerollEnchants then
            pcall(function()
                ...
                if enchantsUI and enchantsUI.Enabled then
                    -- Locate current enchant display label for the selected noob
                    local enchantLabel = enchantsUI:FindFirstChild("EnchantText", true) -- Adjust selector to game UI
                    if enchantLabel and enchantLabel:IsA("TextLabel") then
                        ...
                        if stopRolling then
                            ...
                            -- Fire reroll remote safely without connection spam
                            local args = {
                                [1] = "RerollEnchant",
...
print("[Dominate Hub] V16.9.70 Stable Loaded Successfully!")local oresMined = 0
local mobsKilled = 0
local lastTrackedPart = nil
local lastTrackedMobPart = nil
local currentTargetPanel = nil
