--======================================================================================
-- DOMINATE HUB | PRO EDITION (FIXED UI LAYOUT ORDER, MOB FARMING & STABLE BUILD)
--======================================================================================
local Env = getgenv()
...
-- GLOBAL LAYOUT ORDER COUNTER PER CONTAINER
...
local function createToggleRow(parent, txt, vKey)
    ...
    row.LayoutOrder = getNextOrder(parent)
    row.Parent = parent
...
local function masterToggleGroup(txt, flagsTable, scr)
    ...
    f.BorderSizePixel = 0 
    f.LayoutOrder = getNextOrder(scr)
    f.Parent = scr
...
local function createSectionHeader(parent, txt)
    ...
    header.LayoutOrder = getNextOrder(parent)
...
bestTierBtn.LayoutOrder = getNextOrder(minesScroll)
...
speedContainer.LayoutOrder = getNextOrder(minesScroll)
...
bestMobTierBtn.LayoutOrder = getNextOrder(mobsScroll)
...
killRow.LayoutOrder = getNextOrder(settingsScroll)
...
-- MINER-STYLE AUTO MOB FARMING ENGINE WITH PROPER FOLDER SCANNING
task.spawn(function()
    while Running do
...
print("[Dominate Hub] V11.45 Fixed Layout Order & Lock-On Mob Farming Loaded Successfully!")        corner.Parent = toast
