--======================================================================================
-- DOMINATE HUB | PRO EDITION (STABLE V16.9.104 - sdsaM)[cite: 1]
--======================================================================================
...
Env.AutoRerollEnchants = false[cite: 1]
Env.EnchantSkipAlmighty = false
Env.SelectedEnchantNoob = "Farmer"[cite: 1]
Env.EnchantNoobsList = {[cite: 1]
    "Starter", "Cooker", "Farmer", "Archer", "Soldier", "Fisherman", "Knight", "Explorer", "Magician"[cite: 1]
}
...
print("[Dominate Hub] V16.9.104 Stable Loaded Successfully with Skip Almighty Integration!")
