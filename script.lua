--======================================================================================
-- DOMINATE HUB | V9.7 PRO EDITION (BLENDED TOGGLE BUTTON & GLIDE SPEED IN GENERAL)
--======================================================================================
if getgenv().DominateHubLoaded then 
    ...
    print("[Dominate Hub] Reloading V9.7 Instance...")
end
...
task.spawn(function() local tc = math.random(270, 330) local se = 0 while Running do task.wait(1) if Running and _G.AutoBlazeConvert and NetRemote then se = se + 1 if se >= tc then se = 0 tc = math.random(270, 330) pcall(function() NetRemote:FireServer("Blaze") end) end else se = 0 end end end)end
loadConfigFromSlot(1)
